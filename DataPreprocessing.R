...
SF_totals <- data.frame(PDT, day_total, sub_total, cust_total, day, weekday, month, year)
...
attach(SF_totals)
par(mfrow = c(1,2))
plot(SF_totals$weekday, sub_total, xlab = "Day of the week", ylab = "Number of rentals", main = "Subscribers", col = "skyblue")
plot(SF_totals$weekday, cust_total, xlab = "Day of the week", ylab = "Number of rentals", main = "Customers", col = "slateblue4")
dev.off()
